...
# Main target: Finding most targeting group from four major consumer types(students, adults, members, senior citizen) for speciﬁc event based on estimating ticket type for different events that results in the highest quantity for the art theater in August 2019
